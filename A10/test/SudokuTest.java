...
class SudokuTest {
    ...
    int sprint (int num) throws FileNotFoundException {
        Scanner s = new Scanner(new File("sudoku-board-" + num + ".txt"));
        Sudoku puzzle = Sudoku.read(s);

        puzzle.solve();

        System.out.printf("%n%s%n", puzzle);
    ...
    @Test
    public void pickle() throws FileNotFoundException {
        /*
        puzzle number 5:
        ――――――――――――――――――――――
        │8 5 . │4 2 1 │7 3 6 │
        ...
        puzzle number 6:
        same as number 5, but the 6 on the top left corner isn't there
        ...
        assertEquals(0, sprint(5));
        assertEquals(1, sprint(6));
